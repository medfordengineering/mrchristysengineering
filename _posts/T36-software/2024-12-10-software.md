...
The following is an update showing the lastest version of the typewriter. It is now a self contained unit with a custom PCB that runs on a single power switch.
